...
export default function AdditionDifficultySelection() {
  ...
  useEffect(() => {
    speak(
      "Choisis ton niveau pour devenir un pro de la soustraction !",
  ...
  const difficulties = [
    ...
    { id: 2, title: "Moyen", link: "/cp/soustraction/moyen" },
    { id: 3, title: "Difficile", link: "/cp/soustraction/difficile" },
  ];
